...
const t = {
  en: {
    ...
    footer: {
      ...
      services: ['Port Agency Service', 'Straits Agency Service', 'Shipyard Agency Service', 'Husbandry Agency Service', 'Protecting Agency Service', 'L/S/D Work and Materials Supply'],
  ...
  tr: {
    ...
    footer: {
      ...
      services: ['Liman Acenteliği Hizmeti', 'Boğaz Acenteliği Hizmeti', 'Tersane Acenteliği Hizmeti', 'Husbandry Acenteliği Hizmeti', 'Koruyucu Acentelik Hizmeti', 'L/S/D İşleri ve Malzeme Tedariki'],
